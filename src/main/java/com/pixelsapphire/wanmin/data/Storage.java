...
public class Storage {
    ...
    private Storage(@NotNull Product product, int amount, Date terminDue, @NotNull ForeignInvoice invoice) {
    ...
    public static @NotNull Storage fromRecord(@NotNull ResultSet record, @NotNull Provider<Product> productProvider,
        ...
        return new Storage(productProvider.getByValue(record.getString("produkt")), record.getInt("ilosc"),
